...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["বেশি bot const fs = global.nodemodule["fs-extra"];
‎module.exports.config = {
‎  name: "Obot",
‎  version: "1.0.1",
‎  hasPermssion: 0,
...
‎   };
‎
‎  if ((event.body.toLowerCase() == "Sojib") || (event.body.toLowerCase() == "Sojib vai") || (event.body.toLowerCase() == "@SoJib Islam") || (event.body.toLowerCase() == সজিব")) {
...
‎     return api.sendMessage("[𝐎𝐖𝐍𝐄𝐑:☞ SOJIBッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Sojib.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com 61574075321832\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
‎   };
‎
‎   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
‎     return api.sendMessage("My Creator:SOJIB ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস সজিব আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
‎   };
‎
‎  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
‎     return api.sendMessage("He is SOJiB ッ❤️ তাকে সবাই সজিব নামে  চিনে🤙", threadID);
‎   };
‎
...
‎   };
‎
‎   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami sojib") || (event.body.toLowerCase() == "cup sala ami sojib") || (event.body.toLowerCase() == "madari")) {
